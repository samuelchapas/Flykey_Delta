...
import com.flykey.customkeyboard.emojiKeyboard.onclicklisteners.EmojiOnLongClickListner;
...
public abstract class BaseEmojiGridAdapter extends BaseAdapter {
    ...
    public int getCount() {
        ...
        Log.d("BaseEmojiGridAdapter","getCount" + String.valueOf(emojiList.size()));
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        Log.d("BaseEmojiGridAdapter", "getView" + imageView.getDrawable().toString());
        return imageView;
    }
