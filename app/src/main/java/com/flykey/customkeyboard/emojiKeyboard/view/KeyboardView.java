package com.flykey.customkeyboard.emojiKeyboard.view;
...
import com.flykey.customkeyboard.emojiKeyboard.onclicklisteners.LongButtonPressRunnable;
import com.flykey.customkeyboard.settings.ImePreferences;
...
public class KeyboardView extends View implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    private void setupGoToSettingsButton() {
        ...
        openSettingsButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent emojiKeyboardSettingsIntent = new Intent(getContext(), ImePreferences.class);
    ...
    private void setupEnterButton() {
        ...
        enterButon.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                emojiKeyboardService.keyDownUp(KeyEvent.KEYCODE_ENTER);
            }
        });
    ...
    private void setupSpacebarButton() {
        ...
        spacebarButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                emojiKeyboardService.keyDownUp(KeyEvent.KEYCODE_SPACE);
            }
        });
    ...
    private void setupDeleteButton() {
        ...
        deleteButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                emojiKeyboardService.keyDownUp(KeyEvent.KEYCODE_DEL);
            }
        });
    ...
    private void setupKeyboardButton() {
        ...
        keyboardButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                emojiKeyboardService.handleLanguageSwitch();
            }
        });
    }
    @Override
