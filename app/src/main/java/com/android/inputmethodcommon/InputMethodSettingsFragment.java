...
public abstract class InputMethodSettingsFragment extends PreferenceFragmentCompat
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //PreferenceScreen screenSubs = (PreferenceScreen) getPreferenceManager().findPreference("mainPreference");
        Log.d("InputMethodFragment", getPreferenceScreen().getPreference(2).getKey());

        //Log.d("InputMethodFragment", screenSubs.getTitle().toString());
        //getPreferenceManager().findPreference("mainPreference");
        //setPreferenceScreen(getPreferenceManager().createPreferenceScreen(context));
        //mSettings.init(context, screenSubs);
    }
